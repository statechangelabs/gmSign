...
export interface NonEvilTokenInterface extends utils.Interface {
  functions: {
    ...
    "mintFor(string,address)": FunctionFragment;
...
export interface NonEvilToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NonEvilTokenInterface;
  ...
  functions: {
    ...
    acceptTermsFor(
      ...
      _signatureUrl: PromiseOrValue<string>,
      _UNUSED: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
